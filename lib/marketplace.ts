...
export const MARKETPLACE_CATEGORIES: MarketplaceCategory[] = [
  ...
  { label: "Barber", slug: "barber", aliases: ["barber", "barbier"] },
...
function buildDemoSalons(): MarketplaceSalon[] {
  const rows: MarketplaceSalon[] = [
    ...
    {
      id: "demo-denhaag-houseoffade",
      slug: "house-of-fade-den-haag-889",
      name: "House of Fade",
      city: "Den Haag",
      citySlug: "den-haag",
      categoryLabel: "Barber",
      categorySlug: "barber",
      categoryTags: ["Barber", "Kapper"],
      minPrice: 28,
      rating: 4.8,
      reviewCount: 42,
      coverImageUrl: makePosterUrl("photo-1517832606299-7ae9b720a186"),
      bio: "Premium fades, beard details en vaste tijdsloten zonder wachtrij.",
      openNow: true,
      tags: ["Barber", "Fade"],
      services: [
        {
          id: "demo-barber-1",
          name: "Fade + beard line-up",
          categoryLabel: "Barber",
          categorySlug: "barber",
          description: "Strakke fade met baardafwerking.",
          price: 42,
          durationMin: 45,
        },
      ],
